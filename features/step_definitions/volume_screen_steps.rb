When(/^I swipe in the menu$/) do
  action = Appium::TouchAction.new.swipe(start_x:0.01 ,start_y:0.5 ,end_x:0.8,end_y:0.5, duration:500)
      action.perform
end
...
And(/^I select "([^"]*)" from menu$/) do |value|
  ...
  # 3.times{Appium::TouchAction.new.swipe(start_x:0.5 ,start_y:0.5 ,end_x:0.5,end_y:0.2, duration:500).perform}
